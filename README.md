...
├── knowledge-detective-noir.html  # 主页面（noir 风格）
...
1. **进入游戏**：打开页面后，点击"开始推理"进入案件选择页面
2. **选择案件**：可以选择预设的知识库案件，或上传自己的文档
3. **阅读档案**：仔细阅读案件背景和线索信息
4. **收集线索**：在场景中寻找隐藏的线索和证据
5. **分析证据**：整理收集到的线索，推理案件真相
6. **回答问题**：根据推理结果回答问题，验证你的判断
7. **查看解析**：游戏结束后，查看详细的知识点解析
...
- GitHub Issues：https://github.com/xiaomutou-git/-/issues
