...
> **Demo 作品声明**：本项目是 **TRAE AI 创造力大赛 · 初赛** 的演示作品（Demo），用于展示创意原型与核心交互。当前版本聚焦于可体验的演示功能，未经过生产级打磨，不建议直接用于正式生产环境。

## 项目简介

知识侦探是一款面向学习场景的 Demo 应用，将枯燥的知识内容转化为沉浸式的推理游戏。用户上传文章或文档后，系统会自动生成一个推理剧本，让用户在解谜过程中掌握知识要点。

本项目仅作为**创意演示与技术验证**使用，展示了 AI 辅助学习、前后端分离、响应式交互等能力的结合。
